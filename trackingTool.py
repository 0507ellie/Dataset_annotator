...
class MainWidget(QtWidgets.QWidget):
    def __init__(self, class_path: str, debug = None):
        ...
        pixmap = QtGui.QPixmap(str(Path(__file__).resolve().parent / "demo/trackingUI.png"))
        screen = QtWidgets.QDesktopWidget().screenGeometry()
        ...
        pixmap = QtGui.QPixmap(str(Path(__file__).resolve().parent / "demo/painterUI.png"))
        screen = QtWidgets.QDesktopWidget().screenGeometry()
...
def main(argv=[]):
    ...
    argparser.add_argument('-o','--save_dir', default= os.path.join(os.path.dirname(__file__), "temp"), nargs="?",
